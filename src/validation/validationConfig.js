 ...
 * 
 * This file mirrors shared/validationConfig.js for client-side use.
 * Both files should be kept in sync - update both when changing rules.
 * 
 * TODO: Set up build tooling to import from shared/validationConfig.js directly
 * 
 * Usage:
